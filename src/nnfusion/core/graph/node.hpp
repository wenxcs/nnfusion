...
namespace nnfusion
{
    namespace graph
    {
        ...
        public:
            ...
            // TODO: Deprecate
            std::deque<ngraph::descriptor::Input>& get_inputs() { return m_inputs; }
            // TODO: Deprecate
            const std::deque<ngraph::descriptor::Input>& get_inputs() const { return m_inputs; }
            // Deprecated
            // TODO: Remove from unit tests.
            std::deque<ngraph::descriptor::Output>& get_outputs();
            // Deprecated
            // TODO: Remove from unit tests.
            const std::deque<ngraph::descriptor::Output>& get_outputs() const;
            ...
            ngraph::descriptor::Tensor& get_output_tensor(size_t i) const;

            /// Checks that there is exactly one output and returns its tensor.
            ngraph::descriptor::Tensor& get_output_tensor() const;

            /// Returns the tensor view of output i
            std::shared_ptr<ngraph::descriptor::Tensor> get_output_tensor_ptr(size_t i) const;

            /// Checks that there is exactly one output and returns its tensor view.
            std::shared_ptr<ngraph::descriptor::Tensor> get_output_tensor_ptr() const;

            /// Returns the set of inputs using output i
            const std::set<ngraph::descriptor::Input*>& get_output_inputs(size_t i) const;
            ...
            std::unordered_set<ngraph::descriptor::Tensor*> liveness_new_list;
            std::unordered_set<ngraph::descriptor::Tensor*> liveness_free_list;
            ...
            virtual std::vector<std::shared_ptr<ngraph::Function>> get_functions() const;
            ...
            ngraph::descriptor::Input* get_input_from(const std::shared_ptr<Node>& src);

            /// Get ouput descriptor that outputs to dst
            ngraph::descriptor::Output* get_output_to(const std::shared_ptr<Node>& dst);
        ...
        protected:
            ...
            std::deque<ngraph::descriptor::Input> m_inputs;
            std::deque<ngraph::descriptor::Output> m_outputs;
            std::unordered_map<Node*, ngraph::autodiff::Adjoints> m_adjoint_map;
        ...
        class NodeValidationError : public ngraph::AssertionFailure
        {
        public:
