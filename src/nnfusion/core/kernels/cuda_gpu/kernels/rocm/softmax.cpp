...
cuda::RocmSoftmax::RocmSoftmax(shared_ptr<KernelContext> ctx)
    : CudaLibEmitter(ctx)
{
...
LanguageUnit_p cuda::RocmSoftmax::emit_function_body()
{
    if (!valid_inputs)
        return nullptr;
...
LanguageUnit_p cuda::RocmSoftmax::emit_dependency()
{
