...
std::string cpu::EigenKernelEmitter::emit_eigen_vector(const nnfusion::descriptor::Tensor& tw,
                                                       const string& name)
{
    stringstream ss;
...
std::string cpu::EigenKernelEmitter::emit_eigen_matrix(const nnfusion::descriptor::Tensor& tw,
                                                       const string& name)
{
    stringstream ss;
