...
public:
    ...
    NNFusion_DeiveType get_device_type() const { return m_stream->get_device_type(); }
...
protected:
    AsyncManager(NNFusion_DeiveType device_type);
...
public:
    AsyncManagerFactory() {}
    static AsyncManager* get_async_manager(NNFusion_DeiveType device_type);
